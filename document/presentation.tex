...
\begin{frame}{欠損値の分析}
    \begin{columns}[T]
        ...
        \begin{column}{0.55\textwidth}
            \begin{figure}
                \centering
                \includefigure[width=\textwidth]{figures/missing_values.png}
                \caption{欠損値ヒートマップ}
            \end{figure}
        \end{column}
    \end{columns}
...
\begin{frame}{ロジスティック回帰のチューニング}
    ...
    \begin{figure}
        \centering
        \includefigure[width=0.7\textwidth]{figures/learning_curves/logistic_regression.png}
...
\begin{frame}{MLPのチューニング}
    ...
    \begin{figure}
        \centering
        \includefigure[width=0.7\textwidth]{figures/learning_curves/mlp.png}
        \caption{MLPの学習曲線}
    \end{figure}
\end{frame}
...
\begin{frame}{Random Forestのチューニング}
    ...
    \begin{figure}
        \centering
        \includefigure[width=0.6\textwidth]{figures/feature_importance/random_forest.png}
...
\begin{frame}{テストデータでの評価結果}
    ...
    \begin{figure}
        \centering
        \includefigure[width=0.7\textwidth]{figures/model_comparison.png}
        \caption{評価指標の比較}
    \end{figure}
\end{frame}
...
\begin{frame}{ROCカーブ比較}
    \begin{figure}
        \centering
        \includefigure[width=0.65\textwidth]{figures/roc_curves/comparison.png}
        \caption{ROCカーブの比較}
    \end{figure}
...
\begin{frame}{混同行列}
    \begin{figure}
        \centering
        \includefigure[width=0.9\textwidth]{figures/confusion_matrices/comparison.png}
        \caption{各モデルの混同行列}
    \end{figure}
\end{frame}
